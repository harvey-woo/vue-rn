...
function createElement(type, props, _children) {
  ...
  if (!props) return (0, import_vue.h)(tag, {}, _children);
  ...
  return (0, import_vue.h)(tag, a, _children);
}
...
var View = (0, import_vue2.defineComponent)({
  name: "View",
  props: {
    style: [Object, Array],
...
var Text = (0, import_vue3.defineComponent)({
  name: "Text",
  props: {
    style: [Object, Array],
    class: [String, Array, Object],
...
var Image = (0, import_vue4.defineComponent)({
  name: "Image",
  props: {
    style: [Object, Array],
    class: [String, Array, Object],
...
var TextInput = (0, import_vue5.defineComponent)({
  name: "TextInput",
  props: {
    style: [Object, Array],
    class: [String, Array, Object],
  ...
  setup(props, { emit, attrs }) {
    const val = (0, import_vue5.ref)(props.modelValue ?? props.value ?? "");
    (0, import_vue5.watch)(() => props.modelValue, (v) => {
...
var ScrollView = (0, import_vue6.defineComponent)({
  name: "ScrollView",
  props: {
    style: [Object, Array],
    class: [String, Array, Object],
...
var SafeAreaView = (0, import_vue7.defineComponent)({
  name: "SafeAreaView",
  props: {
    style: [Object, Array],
    class: [String, Array, Object],
...
var ActivityIndicator = (0, import_vue8.defineComponent)({
...
var Switch = (0, import_vue9.defineComponent)({
  name: "Switch",
  props: {
    value: Boolean,
    disabled: Boolean,
  ...
  setup(props, { emit, attrs }) {
    const isOn = (0, import_vue9.ref)(props.value ?? false);
    function toggle() {
...
var Pressable = (0, import_vue10.defineComponent)({
  name: "Pressable",
  props: {
    style: [Object, Array],
    class: [String, Array, Object],
  ...
  setup(props, { slots, attrs, emit }) {
    const pressed = (0, import_vue10.ref)(false);
...
var StatusBar = (0, import_vue11.defineComponent)({
  name: "StatusBar",
  props: {
...
var KeyboardAvoidingView = (0, import_vue12.defineComponent)({
...
var ImageBackground = (0, import_vue13.defineComponent)({
...
var Button = (0, import_vue14.defineComponent)({
  name: "Button",
  props: {
...
var CheckBox = (0, import_vue15.defineComponent)({
  name: "CheckBox",
  props: {
    value: Boolean,
    disabled: Boolean,
...
var ProgressBar = (0, import_vue16.defineComponent)({
  name: "ProgressBar",
  props: {
...
function usePressHandlers(props, emit, extra) {
  const pressed = (0, import_vue17.ref)(false);
  let longPressTimer = null;
  let isLong = false;
...
var TouchableOpacity = (0, import_vue18.defineComponent)({
...
var TouchableHighlight = (0, import_vue18.defineComponent)({
...
var TouchableWithoutFeedback = (0, import_vue18.defineComponent)({
...
function createWebApp(rootComponent) {
  injectReset();
  const app = (0, import_vue19.createApp)(rootComponent);
